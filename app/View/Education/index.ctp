        ...
        <div class="w3-agile-logo">
            <div class=" head-wl">
                <div class="headder-w3">
                    <h1><a href="index.html">FEATURE</a></h1>
                </div>
                <div class=" tele">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="agileits-w3layouts-info">
                        <img src="<?php echo Router::url('/', true);?>img/m1.jpg" alt=""/>
                        <p>survived not only five centuries, but also the leap into electronic typesetting, remaining
    ...
    <div class="container">
        ...
        <div class="about-grids">
            ...
            <div class="col-md-6 about-grid about-w3">
                <img src="<?php echo Router::url('/', true);?>img/a1.jpg" alt=" " class="img-responsive"/>
            </div>
            <div class="clearfix"></div>
        </div>
        <!---728x90--->
...
<div class="services" id="services">
    <div class="container">
        <h3 class="title tittle">Services</h3>
...
<div class="team-all" id="team">
    <div class="container">
        ...
        <p class="para">Cras in risus vitae leo feugiat lobortis euismod quis dui. Integer tempor
            urna quis quam volutpat, non consequat augue iaculis. Proin malesuada sem
            sagittis imperdiet rutrum. </p>
            ...
            <div class="col-md-4 col-sm-4 team-gd">
                <div class="team-left">
                    ...
                    <div class="team-bottom">
                        <h4>wally</h4>
                        <p>non consequat augue iaculis. Proin malesuada sem </p>
                        <ul>
                            <li>
                                <a href="#">
                    ...
                    <div class="t-img">
                        <img src="<?php echo Router::url('/', true);?>img/t1.jpg" alt=" "/>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-4 team-gd">
                <div class="team-left">
                    ...
                    <div class="t-img">
                        <img src="<?php echo Router::url('/', true);?>img/t2.jpg" alt=" "/>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-4 team-gd team-buttom">
                <div class="team-left">
                    <div class="team-top">
                    ...
                    <div class="t-img">
                        <img src="<?php echo Router::url('/', true);?>img/t3.jpg" alt=" "/>
                    </div>
                </div>
            </div>
            <div class="clearfix"></div>
            ...
            <div class="gallery-grids carouselGallery-grid hidden-xs">
                <div class="col-md-4 gallery-grid">
                    <div class="carouselGallery-col-1 carouselGallery-carousel" data-likes="3144" data-index="0"
                         data-username=" " data-imagetext="At vero eos et accusamus et iusto odio
                         ...
                         data-location="Project1" data-imagepath="<?php echo Router::url('/', true);?>img/g1.jpg" data-posturl="#"
                         style="background-image:url(<?php echo Router::url('/', true);?>img/g1.jpg);">
                ...
                <div class="col-md-4 gallery-grid">
                    <div class="carouselGallery-col-1 carouselGallery-carousel" data-likes="3144" data-index="1"
                         data-username=" " data-imagetext="Occaecati at vero eos et accusamus et iusto odio
						 dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores 
						 et quas molestias excepturi sint cupiditate non provident, similique sunt in culpa qui
						 officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio."
                         data-location="Project2" data-imagepath="<?php echo Router::url('/', true);?>img/g2.jpg" data-posturl="#"
                         style="background-image:url(<?php echo Router::url('/', true);?>img/g2.jpg);">
                        <div class="carouselGallery-item">
                            <div class="carouselGallery-item-meta">
								<span class="carouselGallery-item-meta-user">
									Our Gallery
                ...
                <div class="col-md-4 gallery-grid">
                    <div class="carouselGallery-col-1 carouselGallery-carousel" data-likes="3144" data-index="2"
                         data-username=" " data-imagetext="similique sunt in culpa qui
                         ...
                         data-location="Project3" data-imagepath="<?php echo Router::url('/', true);?>img/g3.jpg" data-posturl="#"
                         style="background-image:url(<?php echo Router::url('/', true);?>img/g3.jpg);">
                        <div class="carouselGallery-item">
                            <div class="carouselGallery-item-meta">
								<span class="carouselGallery-item-meta-user">
									Our Gallery
                ...
                <div class="col-md-4 gallery-grid">
                    <div class="carouselGallery-col-1 carouselGallery-carousel" data-likes="3144" data-index="3"
						 ...
						 et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui
						 officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio."
                         data-location="Project4" data-imagepath="<?php echo Router::url('/', true);?>img/g4.jpg" data-posturl="#"
                         style="background-image:url(<?php echo Router::url('/', true);?>img/g4.jpg);">
                        <div class="carouselGallery-item">
                            <div class="carouselGallery-item-meta">
								<span class="carouselGallery-item-meta-user">
									Our Gallery
                ...
                <div class="col-md-4 gallery-grid">
                    <div class="carouselGallery-col-1 carouselGallery-carousel" data-likes="3144" data-index="4"
                         data-username=" " data-imagetext="Similique sunt in culpa qui at vero eos et accusamus et iusto odio
						 dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores 
						 et quas molestias excepturi sint occaecati cupiditate non provident,
						 officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio."
                         data-location="Project5" data-imagepath="<?php echo Router::url('/', true);?>img/g5.jpg" data-posturl="#"
                         style="background-image:url(<?php echo Router::url('/', true);?>img/g5.jpg);">
                        <div class="carouselGallery-item">
                            <div class="carouselGallery-item-meta">
								<span class="carouselGallery-item-meta-user">
									Our Gallery
                ...
                <div class="col-md-4 gallery-grid">
                    <div class="carouselGallery-col-1 carouselGallery-carousel" data-likes="3144" data-index="5"
						 ...
						 et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui
						 officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio."
                         data-location="Project6" data-imagepath="<?php echo Router::url('/', true);?>img/g6.jpg" data-posturl="#"
                         style="background-image:url(<?php echo Router::url('/', true);?>img/g6.jpg);">
                        <div class="carouselGallery-item">
                            <div class="carouselGallery-item-meta">
								<span class="carouselGallery-item-meta-user">
									Our Gallery
                ...
                <ul class="slides">
                    <li>
                        <div class="banner-bottom">
                            <div class="about-midd-main">
                                <div class="about-img">
                                    <a href="#" data-toggle="modal" data-target="#myModal1"><img class="agile-img"
                                                                                                 src="<?php echo Router::url('/', true);?>img/n1.jpg"
                                                                                                 alt=" "></a>
                                </div>
                                <div class="w3-test">
                                    <h4><span>14</span> November</h4>
                                    <h5><a href="#" data-toggle="modal" data-target="#myModal1">NEWS 1</a></h5>
                                    <p> consectetur adipiscing elit, sed do eiusmod idunt ut labore.</p>
                    ...
                    <li>
                        <div class="banner-bottom">
                            <div class="about-midd-main">
                                <div class="about-img">
                                    <a href="#" data-toggle="modal" data-target="#myModal2"><img class="agile-img"
                                                                                                 src="<?php echo Router::url('/', true);?>img/n2.jpg"
                                                                                                 alt=" "></a>
                                </div>
                                <div class="w3-test">
                                    <h4><span>16</span> November</h4>
                                    <h5><a href="#" data-toggle="modal" data-target="#myModal2">NEWS 2</a></h5>
                                    <p>consectetur adipiscing elit, sed do eiusmod idunt ut labore.</p>
                                    <a href="#" class="view" data-toggle="modal" data-target="#myModal1">Read More</a>
                                </div>
                            </div>
                    ...
                    <li>
                        <div class="banner-bottom">
                            <div class="about-midd-main">
                                <div class="about-img">
                                    <a href="#" data-toggle="modal" data-target="#myModal3"><img class="agile-img"
                                                                                                 src="<?php echo Router::url('/', true);?>img/n3.jpg"
                                                                                                 alt=" "></a>
                                </div>
                                <div class="w3-test">
                                    <h4><span>5</span> September</h4>
                                    <h5><a href="#" data-toggle="modal" data-target="#myModal3">NEWS 3</a></h5>
                                    <p> consectetur adipiscing elit, sed do eiusmod idunt ut labore.</p>
                                    <a href="#" class="view" data-toggle="modal" data-target="#myModal1">Read More</a>
                                </div>
                            </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <img src="<?php echo Router::url('/', true);?>img/n1.jpg" alt="blog-image"/>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4>Our News</h4>
                <p>Lorem ipsum dolor sit amet</p>
                <img src="<?php echo Router::url('/', true);?>img/n2.jpg" alt="blog-image"/>
                <span>Lorem ipsum dolor sit amet, Sed ut perspiciatis unde omnis iste natus error sit voluptatem , eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.accusantium doloremque laudantium, totam rem aperiamconsectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4>Our News</h4>
                <p>Lorem ipsum dolor sit amet</p>
                <img src="<?php echo Router::url('/', true);?>img/n3.jpg" alt="blog-image"/>
                <span>Lorem ipsum dolor sit amet, Sed ut perspiciatis unde omnis iste natus error sit voluptatem , eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.accusantium doloremque laudantium, totam rem aperiamconsectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
            </div>
        </div>
...
<div class="contact-top">
    <iframe
        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3745.657945920633!2d94.925709!3d20.148312999999998!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30b7d19881308ae9%3A0x229dbaae31b864b9!2sZarmani!5e0!3m2!1sen!2sin!4v1419654909172"></iframe>
</div>
<!--footer-->
<div class="buttom-w3">
    <div class="container">
        <div class="col-md-4 bottom-head text-center">
            <h3><a href="index.html">Feature</a></h3>
...
<footer>
    <p> Feature &copy; 2017 . All Rights Reserved | Design by <a href="http://w3layouts.com/" target="_blank">
            W3layouts </a></p>
</footer>
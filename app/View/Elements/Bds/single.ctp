    ...
    <div class="container">
            ...
            <div class="standard_content" style="height: 439px;">
                <div class="standard active" data-selector="1">
                    <ul class="single_grid">
                        <li><img src="<?php echo Router::url('/', true);?>img/s2.jpg" class="img-responsive" alt=""/></li>
                        <li><img src="<?php echo Router::url('/', true);?>img/s3.jpg" class="img-responsive" alt=""/></li>
                        <li><img src="<?php echo Router::url('/', true);?>img/s4.jpg" class="img-responsive" alt=""/></li>
                        <li><img src="<?php echo Router::url('/', true);?>img/s5.jpg" class="img-responsive" alt=""/></li>
                        <li><img src="<?php echo Router::url('/', true);?>img/s6.jpg" class="img-responsive" alt=""/></li>
                        <li><img src="<?php echo Router::url('/', true);?>img/s7.jpg" class="img-responsive" alt=""/></li>
                        <li><img src="<?php echo Router::url('/', true);?>img/s8.jpg" class="img-responsive" alt=""/></li>
                        <li><img src="<?php echo Router::url('/', true);?>img/s9.jpg" class="img-responsive" alt=""/></li>
        ...
        <div class="about_grid2">
            ...
            <div class="col-md-3 about_box2">
                <img src="<?php echo Router::url('/', true);?>img/a1.jpg" class="img-responsive" alt=""/>
                <h3>suffered </h3>
            ...
            <div class="col-md-3 about_box2">
                <img src="<?php echo Router::url('/', true);?>img/a2.jpg" class="img-responsive" alt=""/>
                <h3>suffered </h3>
                <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it</p>
            </div>
            <div class="col-md-3 about_box2">
                <img src="<?php echo Router::url('/', true);?>img/a3.jpg" class="img-responsive" alt=""/>
                <h3>suffered </h3>
                <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it</p>
            </div>
            <div class="col-md-3 about_box2">
                <img src="<?php echo Router::url('/', true);?>img/a4.jpg" class="img-responsive" alt=""/>
                <h3>suffered </h3>
                <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it</p>
            </div>
            <div class="clearfix"> </div>
